...
plot(WD.zoo_m,xlab='Year', ylab='Discharge (Cft/s)',main="Comal Springs discharge (before imputation)")#see if any visible periods of missing values
...
plot(WD.zoo_p,xlab='Year',ylab='Discharge(cft/s)',main="Comal Springs discharge after imputation") 
summary(WD.zoo_p)
...
acf(WD.zoo_p,lag.max=NULL,main='ACF for ComalSprings', type = c('correlation'))
pacf(WD.zoo_p,main='PACF for ComalSprings',type="o")
